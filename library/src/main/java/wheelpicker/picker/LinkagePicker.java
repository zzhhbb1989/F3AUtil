...
import wheelpicker.entity.LinkageFirst;
import wheelpicker.entity.LinkageSecond;
import wheelpicker.entity.LinkageThird;
...
public class LinkagePicker<Fst extends LinkageFirst<Snd>, Snd extends LinkageSecond<Trd>, Trd> extends WheelPicker {
    ...
    public void setSelectedItem(Fst fst, Snd snd, Trd trd) {
        ...
        LogUtils.verbose("initList select first: " + fst.getName() + ", index:" + selectedFirstIndex);
        //noinspection unchecked
        ...
        LogUtils.verbose("initList select second: " + snd.getName() + ", index:" + selectedSecondIndex);
        ...
        for (Trd t : trds) {
            if (t.equals(trd)) {
                ...
                if (ltrd != null && (lt.getId().equals(ltrd.getId()) || lt.getName().contains(ltrd.getName()))) {
                    selectedThirdIndex = k;
                    break;
                }
            }
        ...
        LogUtils.verbose("initList select third: " + trd + ", index:" + selectedThirdIndex);
    }
