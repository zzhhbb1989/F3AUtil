...
public class NumberPicker extends SinglePicker<Number> {
    ...
    public void addOnNumberPickListener(OnNumberPickListener listener) {
        super.addOnItemPickListener(listener);
    }

    /**
     * @deprecated use {@link #addOnNumberPickListener(OnNumberPickListener)} instead
     */
    @Deprecated
    public void setOnOptionPickListener(final OptionPicker.OnOptionPickListener listener) {
        addOnNumberPickListener(new OnNumberPickListener() {
            @Override
    ...
    public void addOnWheelListener(OnWheelListener onWheelListener) {
        super.addOnWheelListener(onWheelListener);
    }
